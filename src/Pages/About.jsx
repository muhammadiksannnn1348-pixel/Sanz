  ...
  return (
    <div className="flex justify-center lg:justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
      ...
      >
        ...
        <div className="absolute -inset-10 opacity-60 z-0 hidden sm:block pointer-events-none">
          <div className="absolute inset-0 rounded-full border border-dashed border-indigo-500/30 animate-spin-slow" />
          <div className="absolute inset-4 rounded-full border border-purple-500/20 animate-spin-reverse" style={{ animationDuration: '15s' }} />
          <div className="absolute inset-8 rounded-full border border-fuchsia-500/10 animate-spin-slow" style={{ animationDuration: '25s' }} />
        </div>

        {/* Orbiting dots */}
        <div className="absolute -inset-10 z-0 hidden sm:block pointer-events-none">
          <div className="absolute inset-0 animate-spin-slow">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2 h-2 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full shadow-lg shadow-purple-500/50" />
          </div>
          <div className="absolute inset-0 animate-spin-reverse">
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 bg-gradient-to-r from-fuchsia-400 to-pink-400 rounded-full shadow-lg shadow-fuchsia-500/50" />
          </div>
          <div className="absolute inset-0 animate-spin-slow" style={{ animationDuration: '18s' }}>
            <div className="absolute top-1/2 right-0 -translate-y-1/2 w-1.5 h-1.5 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full shadow-lg shadow-cyan-500/50" />
          </div>
        </div>

        {/* Glow aura behind */}
        <div className="absolute -inset-6 opacity-[35%] z-0 hidden sm:block pointer-events-none">
        ...
        >
          ...
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_60px_rgba(120,119,198,0.5)] transform transition-all duration-700">
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-700 z-20 hidden sm:block pointer-events-none">
              <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/25 to-transparent transform -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
            </div>

            {/* Corner brackets */}
            <div className="absolute inset-4 z-30 pointer-events-none hidden sm:block">
              ...
              <div className="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-fuchsia-400/70" />
              <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-fuchsia-400/70" />
            </div>
          </div>
